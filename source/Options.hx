...
class MiddlescrollOption extends Option
{
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.middlescroll ? "Middlescroll" : "Normalscroll";
	}
}
...
class VideoOption extends Option
{
	...
	public override function press():Bool
	{
		FlxG.save.data.invsib = !FlxG.save.data.invsib;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.invsib ? "Gameplay Video" : "No Gameplay Video";
	}
}
